...
public class Mqtt {
    ...
    private String subTopic = "testtopic/#";
    ...
    public Mqtt(String address, String port, String id) throws MqttException, IOException {
        ...
        //TODO find out how the programe can tel the user that it didnt connect to the broker, insted of the program crashing.
        //Checks if the client is connected to the broker.
        String line = "";
        if(this.client.isConnected() == true) {
            System.out.println("Connected to the broker: " + this.broker);

            //TODO Find out why when "Disconnect" it sends the masseg to the broker.
